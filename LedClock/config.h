...
// Communication interface to TM1637 module.
#define TM1637_INTERFACE_TYPE_NORMAL 0
#define TM1637_INTERFACE_TYPE_FAST 1
...
#define SYSTEM_CLOCK_TYPE SYSTEM_CLOCK_TYPE_COROUTINE
  ...
  #define TM1637_INTERFACE_TYPE TM1637_INTERFACE_TYPE_FAST
  #define CLK_PIN 10
  #define DIO_PIN 9
  ...
  #define LED_DISPLAY_TYPE LED_DISPLAY_TYPE_TM1637
  #define LED_MATRIX_MODE LED_MATRIX_MODE_NONE
  #define TM1637_INTERFACE_TYPE TM1637_INTERFACE_TYPE_NORMAL
  #define CLK_PIN PB3
  #define DIO_PIN PB4
  #define BIT_DELAY 100
